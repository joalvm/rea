      ...
      <View style={styles.screen}>
        <View style={styles.header}>
          ...
          <View style={styles.headerText}>
            <Text style={styles.kicker}>Horario de Mensu</Text>
            <Text style={styles.title}>Cuándo puede preguntarte</Text>
          </View>
        </View>

        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          <Text style={styles.helper}>
            Activa solo momentos cómodos. Las notificaciones son discretas y no muestran datos sensibles.
          </Text>
    ...
    <SoftCard style={styles.momentCard}>
      ...
      <View style={styles.days}>
        {DAYS.map((day) => {
          ...
          return (
            <Pressable key={`${moment.id}-${day.key}`} onPress={() => toggleDay(day.key)} style={[styles.day, active && styles.dayActive]}>
