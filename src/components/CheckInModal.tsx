...
const BLEEDING: Array<{ key: BleedingLevel; label: string }> = [
  { key: "none", label: "Nada" },
      ...
      <View style={styles.scrim}>
        ...
        <View style={styles.sheet}>
          ...
          <View style={styles.header}>
            <View>
              <Text style={styles.kicker}>{mode === "daily" ? "Registro de hoy" : "Check-in corto"}</Text>
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            <MetricScale highLabel="Muy bien" label="Ánimo" lowLabel="Bajo" onChange={setMood} value={mood} />
            <MetricScale highLabel="Alta" label="Energía" lowLabel="Baja" onChange={setEnergy} value={energy} />
            <MetricScale highLabel="Fuerte" label="Dolor" lowLabel="Nada" onChange={setPain} value={pain} />
            <MetricScale highLabel="Alto" label="Estrés" lowLabel="Bajo" onChange={setStress} value={stress} />
                ...
                <View style={styles.section}>
                  ...
                  <View style={styles.chips}>
                    {BLEEDING.map((item) => (
                      ...
                      >
                        <Text style={[styles.chipText, bleedingLevel === item.key && styles.chipTextActive]}>
                          {item.label}
                        </Text>
                      </Pressable>
                    ))}
            ...
            <SoftButton label="Guardar registro" loading={saving} onPress={submit} />
            <Text style={styles.privacy}>Solo se guarda en este dispositivo. No se envía a ningún servidor.</Text>
          </ScrollView>
        </View>
      </View>
    </Modal>
